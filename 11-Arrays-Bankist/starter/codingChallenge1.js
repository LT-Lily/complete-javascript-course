...
// forEach dog age <=3 ? "adult" : "puppy"
// 1st and last 2 are cats. Splice
// Concat Julia's - cats and kate's
...
console.log('---Test data set 1---');
checkDogs(juliaNewData, kateData);
console.log('---Test data set 2---');
checkDogs(juliaNewData2, kateData);
